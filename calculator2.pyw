...
input_frame = Frame(window, width=312, height=50, bd=0, highlightcolor='black', highlightbackground='black')
input_frame.pack(side=TOP)

input_field = Entry(input_frame, font=('arial', 18, 'bold'), textvariable=input_text, width=50, bg='lightgrey', bd=0,
                    justify=RIGHT)
...
button_clear = Button(frame_button, text='C', fg='black', width=55, height=3, bd=1, bg='white', cursor='hand2',
...
sapte = Button(frame_button, text='7', fg='black', width=18, height=3, bd=1, bg='lightblue', cursor='hand2',
               command=lambda: click('7')).grid(row=1, column=0)
opt = Button(frame_button, text='8', fg='black', width=18, height=3, bd=1, bg='lightblue', cursor='hand2',
             command=lambda: click('8')).grid(row=1, column=1)
noua = Button(frame_button, text='9', fg='black', width=17, height=3, bd=1, bg='lightblue', cursor='hand2',
...
patru = Button(frame_button, text='4', fg='black', width=18, height=3, bd=1, bg='lightblue', cursor='hand2',
               command=lambda: click('4')).grid(row=2, column=0)
cinci = Button(frame_button, text='5', fg='black', width=18, height=3, bd=1, bg='lightblue', cursor='hand2',
               command=lambda: click('5')).grid(row=2, column=1)
sase = Button(frame_button, text='6', fg='black', width=17, height=3, bd=1, bg='lightblue', cursor='hand2',
...
unu = Button(frame_button, text='1', fg='black', width=18, height=3, bd=1, bg='lightblue', cursor='hand2',
             command=lambda: click('1')).grid(row=3, column=0)
doi = Button(frame_button, text='2', fg='black', width=18, height=3, bd=1, bg='lightblue', cursor='hand2',
             command=lambda: click('2')).grid(row=3, column=1)
trei = Button(frame_button, text='3', fg='black', width=17, height=3, bd=1, bg='lightblue', cursor='hand2',
...
zero = Button(frame_button, text='0', fg='black', width=37, height=3, bd=1, bg='lightblue', cursor='hand2',
              command=lambda: click('0')).grid(row=4, column=0, columnspan=2)
virgula = Button(frame_button, text='.', fg='black', width=17, height=3, bd=1, bg='lightblue', cursor='hand2',
